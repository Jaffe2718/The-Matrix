...
public class SelectEnemyGoal extends ActiveTargetGoal<LivingEntity> {
    public SelectEnemyGoal(ZionPeopleEntity mob, boolean checkVisibility) {
        super(mob, LivingEntity.class, checkVisibility, livingEntity -> EntityRegistry.ROBOT_CLASSES.contains(livingEntity.getClass()));
    }
